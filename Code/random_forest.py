...
submit.to_csv('data/baseline/log_reg_baseline.csv', index = False)
...
submit.to_csv('data/baseline/random_forest_baseline.csv', index = False)
...
plt.savefig('plots/baseline_plot_1.png')
plt.show()
